...
// Load all signups from Supabase
async function loadSignups() {
    ...
    try {
        ...
        showError('Failed to load signups. Please check your Supabase configuration.');
        showLoading(false);
    }
}
...
function displaySignups() {
    ...
    pageSignups.forEach((signup, index) => {
        ...
        const locationStr = [signup.city, signup.region, (signup.country_name || signup.country)]
            .filter(Boolean)
            .join(', ');
    ...
    searchInput.addEventListener('input', (e) => {
        ...
        if (searchTerm === '') {
            ...
            filteredSignups = allSignups.filter(signup => 
                ...
                [signup.city, signup.region, (signup.country_name || signup.country)]
                    .filter(Boolean)
                    .join(', ')
                    .toLowerCase()
                    .includes(searchTerm) ||
